export default function Header({ locale='es' }) {
  const nav = {
    es: { destinos: 'Ejemplos', servicios: 'Servicios', cursos: 'Cursos', contacto: 'Contacto', disena: 'Diseña tu viaje' },
    fr: { destinos: 'Exemples', servicios: 'Services', cursos: 'Cours', contacto: 'Contact', disena: 'Concevez votre voyage' }
  }[locale];
  return (
    <header className="border-b border-gray-200">
      <div className="container-max py-4 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-6 text-sm">
          <a className="hover:text-brandWine" href={locale==='es'?'/es#ejemplos':'/fr#ejemplos'}>{nav.destinos}</a>
